        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div class="header-title">
                    <h4 class="card-title">Laporan Barang Masuk (Detail Item)</h4>
                </div>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="reportTable" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <tr>
                                <td colspan="7" class="text-center text-muted">Klik "Tampilkan Laporan" untuk memuat data</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        function loadReport() {
            ...
            $.ajax({
                url: '<?= base_url('report/fetchPurchaseItemReport') ?>',
                type: 'GET',
                data: {
                    startDate: startDate,
                    endDate: endDate
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        ...
                        if (response.data.length === 0) {
                            tbody.append('<tr><td colspan="7" class="text-center">Tidak ada data untuk periode yang dipilih</td></tr>');
                        } else {
                            var html = '';
                            $.each(response.data, function(index, item) {
                                var tanggal = item.tanggal_masuk ? new Date(item.tanggal_masuk).toLocaleString('id-ID') : '-';
                        ...
                        $('#reportTable').DataTable({
                            ...
                            buttons: [{
                                    ...
                                    title: 'Laporan Barang Masuk Detail - ' + startDate + ' s/d ' + endDate
                                },
                                {
                                    extend: 'excelHtml5',
                                ...
                                },
                                {
                                    ...
                                    title: 'Laporan Barang Masuk Detail',
