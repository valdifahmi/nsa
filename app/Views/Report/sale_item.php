        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div class="header-title">
                    <h4 class="card-title">Laporan Barang Keluar (Detail Item)</h4>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        function loadReport() {
            ...
            $.ajax({
                url: '<?= base_url('report/fetchSaleItemReport') ?>',
                type: 'GET',
                data: {
                    startDate: startDate,
                    endDate: endDate
                    ...
                    if (response.status === 'success') {
                        ...
                        $('#reportTable').DataTable({
                            ...
                            buttons: [{
                                    ...
                                    title: 'Laporan Barang Keluar Detail - ' + startDate + ' s/d ' + endDate
                                },
                                {
                                    extend: 'excelHtml5',
                                ...
                                },
                                {
                                    ...
                                    title: 'Laporan Barang Keluar Detail',
